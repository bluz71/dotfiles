...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#373c40', '#ff5454', '#8cc85f', '#e3c78a', '#80a0ff', '#d183e8', '#7ee0ce', '#a1aab8', '#7c8f8f', '#f74782', '#42cf89', '#bfbf97', '#78c2ff', '#ae81ff', '#85dc85', '#e2637f']"
...
gset string palette "#373c40:#ff5454:#8cc85f:#e3c78a:#80a0ff:#d183e8:#7ee0ce:#a1aab8:#7c8f8f:#f74782:#42cf89:#bfbf97:#78c2ff:#ae81ff:#85dc85:#e2637f"
