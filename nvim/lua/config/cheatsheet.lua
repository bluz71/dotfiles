...
cheatsheet.setup({
  ...
  keymaps = {
    ...
    ["Helper Mappings"] = {
      ...
      { "Clone line & comment out", "ycc" },
      { "Clone paragraph", "cp" },
      { "Format paragraph", "qp" },
      { "Format line", "qj" },
      { "Toggle current fold", ",z" },
      { "Expand all folds", ",Z" },
      { "Toggle crosshair", ",x" },
      { "Maximise current split into a tab", ",m" },
      { "Maximize vertical height", ",+" },
      { "Introduction message", ",i" },
      { "Move visual block up", "K" },
      { "Move visual block down", "J" },
      { "Launch Undotree", ",u" },
      { "Expand UI2 messages", "‹Ctrl-Right›" },
    },
    ["Paired Mappings"] = {
      { "Previous file", "[a" },
      { "Next file", "]a" },
    ...
    ["Snacks Plugin Mappings"] = {
      { "Open Lazygit", "‹Ctrl-g›" },
      { "Toggle scope indent guide", "‹Ctrl-s›" },
      { "Files", "‹Spc›‹Spc›" },
      { "Smart Files", "‹Spc›s" },
      { "Close", "‹Esc›" },
      ...
      { "Send selections to quickfix", "‹Alt-q›" },
      { "Delete buffer selections", "‹Alt-d›" },
      { "Sibling files", "‹Spc›." },
      { "Buffers", "‹Spc›," },
