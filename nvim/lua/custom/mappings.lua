...
-- Expand UI2 messages into a buffer.
map("n", "<C-Right>", "g<")
-- Disable arrow keys.
map("n", "<Up>", "<Nop>")
map("n", "<Down>", "<Nop>")
...
map("n", "<F7>", ":set lazyredraw!<CR>:set autoread!<CR>:call AutoSaveToggle()<CR>")
map("n", "'7", ":set lazyredraw!<CR>:set autoread!<CR>:call AutoSaveToggle()<CR>")
